...
*Inspired by:* [YouTube](https://www.youtube.com/watch?v=ZOLkWBVMcwU)
...
A common mnemonic for remembering these layers, bottom to top, is: "Please Do Not Throw Sausage Pizza Away" (Physical, Data Link, Network, Transport, Session, Presentation, Application).
...
If the network is fine but the server returns an error: Layer 7 problem.
...
If you can connect but communication is garbled or decryption fails: Layer 6 problem.
...
If everything connects but data is corrupted or lost: Layer 4/higher problem.
...
If you can reach your router but not the internet: Layer 3 problem.
...
If your device is connected to the network but can't communicate with other devices on the same subnet: Layer 2 problem.
...
If your cable is unplugged: Layer 1 problem.
