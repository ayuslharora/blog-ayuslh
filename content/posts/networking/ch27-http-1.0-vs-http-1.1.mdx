...
![How HTTP/1.1 pipelining works, disabled by default: multiple requests sent without waiting for previous responses, but responses must be sent back in the same order, causing head-of-line blocking](/images/ch27-http11-pipelining-hol-blocking.png)
