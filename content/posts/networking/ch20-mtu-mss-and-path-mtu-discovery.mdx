...
* **The Ethernet frame header is not part of the MTU.** The 14-byte Ethernet header (source MAC, destination MAC) that gets attached at the data link layer sits outside this calculation entirely. The 1500 bytes you see refers strictly to the IP packet's size.
