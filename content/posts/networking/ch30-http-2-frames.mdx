...
> **Note:** HTTP/2 can have another HEADERS frame later in the same stream for trailing headers (trailers). This is not common in regular web traffic, but is used by protocols like gRPC.
