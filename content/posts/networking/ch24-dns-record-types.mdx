...
```mermaid
flowchart LR
    Sender(["Sender<br/>test@example.com"])
    ...
    Sender -- "1. from: test@example.com<br/>to: test@gmail.com<br/>sending IP: 14.202.168.11" --> Recv
    Recv <-- "2. PTR query: 14.202.168.11<br/>PTR response: mail.example.com" --> DNS
    Recv <-- "3. A query: mail.example.com<br/>4. A response: 14.202.168.11" --> DNS
