...
*Inspired by:* [YouTube](https://www.youtube.com/watch?v=B3JwzcPTZDw)
...
<MdxImage src="/images/ch22-cwnd-retransmission-timeout.png" alt="Line chart of cwnd against round trip number, climbing exponentially to 128 then linearly to 800 as in the previous chart, but this time crashing all the way down to 1 on timeout and reclimbing the full exponential Slow Start curve up to a dotted reference line marking the new ssthresh of 400" className="w-full h-auto rounded-lg my-6" />
