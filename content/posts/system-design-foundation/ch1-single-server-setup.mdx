...
flowchart LR
    ...
    style User fill:transparent,stroke:#52525b,stroke-width:1.5px,color:#111827
    style WSBox stroke-dasharray: 4 3,fill:transparent,stroke:#52525b,stroke-width:1.5px,color:#111827
    style WB fill:transparent,stroke:none
    style MA fill:transparent,stroke:none
    style WS fill:transparent,stroke:none
    style DNS fill:#dbeafe,stroke:#3b82f6,stroke-width:1.5px,color:#1e3a8a
```
