...
*Inspired by:* [YouTube](https://www.youtube.com/watch?v=ashGekqstl8)
...
The simple linear regression equation was `y = mx + b`. With two inputs, $x_1$ and $x_2$, it becomes:

$$\hat{y} = \beta_0 + \beta_1 x_1 + \beta_2 x_2$$

Written in the more standard notation, with `cgpa` as $x_1$ and `iq` as $x_2$:

```python
b0, (b1, b2) = lr.intercept_, lr.coef_
```

$$\beta_0 = -1.3994 \qquad \beta_1 = 85.5640 \qquad \beta_2 = 30.8590$$
