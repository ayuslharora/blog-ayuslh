...
On a 10-class problem the diagonal becomes a solid wall and every off-diagonal cell is a named confusion ("true 4, predicted 8"). A single accuracy number would collapse that entire landscape into one height; the matrix keeps the shape.
