...
A box plot is the standard visualization for IQR-based statistics. Every element maps directly to a quantile:

```text
   |---whisker---|  [  Q1 ---- Median ---- Q3  ]  |---whisker---|  o  o  o
  Lower limit   Q1                              Q3         Upper limit  <- outliers
```
