...
<img src="/images/ch34-boxplot-before.png" alt="Box plot of placement exam marks showing the box from Q1=17 to Q3=44, with the upper whisker ending at the IQR limit of 84.5 and 15 outlier dots scattered to the right beyond it" className="w-full h-auto" />
