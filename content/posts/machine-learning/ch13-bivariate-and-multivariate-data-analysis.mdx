...
<MdxImage src="/images/ch13-scatter-bill-tip.png" alt="Scatter plot of total bill versus tip amount" className="w-full h-auto" />
...
<MdxImage src="/images/ch13-scatter-multivariate.png" alt="Scatter plot encoding total bill, tip, gender, smoker status, and party size" className="w-full h-auto" />
...
<MdxImage src="/images/ch13-lineplot-flights.png" alt="Line plot of annual US airline passenger volume from 1949 to 1960" className="w-full h-auto" />
...
<MdxImage src="/images/ch13-pairplot-iris.png" alt="Pair plot grid of Iris features color-coded by species" className="w-full h-auto" />
...
<MdxImage src="/images/ch13-barplot-pclass-age.png" alt="Bar plot of average passenger age across ticket classes with confidence interval error bars" className="w-full h-auto" />
...
<MdxImage src="/images/ch13-barplot-pclass-fare-sex.png" alt="Bar plot of average ticket fare by passenger class, split by gender" className="w-full h-auto" />
...
<MdxImage src="/images/ch13-boxplot-sex-age-survived.png" alt="Box plot of age distribution split by gender and survival status" className="w-full h-auto" />
...
<MdxImage src="/images/ch13-kde-survival-overlay.png" alt="Overlaid KDE curves of age probability density for survived versus died passengers" className="w-full h-auto" />
...
<MdxImage src="/images/ch13-heatmap-crosstab.png" alt="Heatmap of passenger class versus survival count" className="w-full h-auto" />
...
<MdxImage src="/images/ch13-clustermap-flights.png" alt="Cluster map of monthly flight volumes with hierarchical clustering dendrograms" className="w-full h-auto" />
...
3. **Bivariate & Correlation Matrices**: Automatically computes correlation matrices using multiple coefficients:
   ...
   * **Phik (φₖ) Correlation**: Inter-variable correlation handling both numerical and categorical variables simultaneously.
