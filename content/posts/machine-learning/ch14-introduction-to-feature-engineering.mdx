...
<MdxImage src="/images/ch14-outlier-regression-impact.png" alt="Side-by-side regression plots showing a fitted line skewed by outliers versus a clean fit after removing them" className="w-full h-auto" />
...
<MdxImage src="/images/ch14-family-size-output.png" alt="DataFrame output showing SibSp, Parch, the constructed Family_Size column, and the binned Family_Type column" className="w-full h-auto" />
...
<MdxImage src="/images/ch14-mnist-pixel-variance.png" alt="A sample MNIST digit next to a heatmap of per-pixel variance, showing near-zero variance at the border and high variance at the center" className="w-full h-auto" />
...
<MdxImage src="/images/ch14-pca-iris.png" alt="Scatter plot of the Iris dataset projected from 4 original features onto 2 principal components via PCA, colored by species" className="w-full h-auto" />
