...
<img src="/images/ch21-qq-normal-vs-skewed.png" alt="Q-Q plot comparison of Age, which sits close to the reference line, versus Fare, which sags below the line early and curves sharply above it" className="w-full h-auto rounded-lg my-8" />
...
<img src="/images/ch21-age-distribution-qq.png" alt="Histogram and Q-Q plot of the Age column, showing a roughly bell-shaped distribution close to the reference line" className="w-full h-auto rounded-lg my-6" />

<img src="/images/ch21-fare-distribution-qq.png" alt="Histogram and Q-Q plot of the Fare column, showing a heavily right-skewed distribution with a long thin tail" className="w-full h-auto rounded-lg my-6" />
...
<img src="/images/ch21-fare-log-transform-qq.png" alt="Q-Q plot of Fare before and after the log1p transform, showing the points moving noticeably closer to the reference line after the transform" className="w-full h-auto rounded-lg my-8" />
