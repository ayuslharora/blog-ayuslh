...
<img src="/images/ch15-distance-term-dominance.png" alt="Bar chart on a log scale comparing the squared Age term (400) against the squared Salary term (3.6 billion)" className="w-full h-auto" />
...
<img src="/images/ch15-scatter-before-after.png" alt="Side-by-side scatter plots of Age versus Salary before and after standardization, showing the identical point layout on different axis scales" className="w-full h-auto" />
...
<img src="/images/ch15-kde-before-after.png" alt="KDE density plots of Age and Salary before scaling, where Age is flattened by Salary's scale, and after scaling, where both distributions share a common range" className="w-full h-auto" />
...
<img src="/images/ch15-accuracy-comparison.png" alt="Grouped bar chart comparing Logistic Regression and Decision Tree accuracy with and without standardization" className="w-full h-auto" />
...
<img src="/images/ch15-outlier-standardization.png" alt="Scatter plots showing a salary outlier at $350,000 before scaling and its still-extreme scaled position after standardization" className="w-full h-auto" />
