...
The rule of thumb used throughout the source material: keep adding components until the curve crosses **90% explained variance**, then stop. Here that happens at **232 components**, less than a third of the original 784. (The curve climbs much more slowly than it would on a toy digit dataset, because real handwritten strokes vary across a genuinely large number of independent directions, corner thickness, slant, loop width, stroke pressure, and so on. 90% variance needs 232 components out of 784; 95% needs 325.)
