...
<img src="/images/ch39-projection-illustration.png" alt="A data point x with a perpendicular dotted line dropped onto a candidate axis defined by unit vector u, landing at the projected point u transpose x" className="w-full h-auto" />
