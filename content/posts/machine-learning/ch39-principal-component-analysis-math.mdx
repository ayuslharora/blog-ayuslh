...
To make this concrete, here's the whole pipeline run on a real synthetic dataset: 40 points with 3 features (`feature1`, `feature2`, `feature3`) split across 2 classes.
