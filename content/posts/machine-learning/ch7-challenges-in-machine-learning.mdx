...
date: "2026-07-17T03:06:00+05:30"
tags: ["machine-learning", "mlops", "data-quality", "overfitting"]
subtopic: "ML Engineering & Data Basics"
draft: false
---

*Inspired by:* [YouTube](https://www.youtube.com/watch?v=WGUNAJki2S4)
...
<div className="my-8 rounded-xl overflow-hidden shadow-xl border border-white/10">
  <MdxImage src="/images/overfitting-diagram.png" alt="Underfitting vs Optimal Fit vs Overfitting Diagram" className="w-full h-auto" />
</div>
